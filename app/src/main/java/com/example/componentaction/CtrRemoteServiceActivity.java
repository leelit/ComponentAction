...
public class CtrRemoteServiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(final View v) {
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                intent.setComponent(new ComponentName(CtrRemoteServiceActivity.this, MyService.class));
                switch (v.getId()) {
                    ...
                    case R.id.binder_call:
                        if (myBinder == null){
                            Toast.makeText(CtrRemoteServiceActivity.this, "please bind service first", Toast.LENGTH_SHORT).show();
                            return;
                        }
